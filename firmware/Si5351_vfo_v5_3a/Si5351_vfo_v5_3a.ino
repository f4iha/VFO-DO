/*
 ...
 v5_3a  11 March, 2021   The variable "validGPSflag" can now equal 1 or 2 to proceed 
...
void loop()
{
  if (s_GpsOneSecTick)
  {
    ...
    if (validGPSflag == 1 | validGPSflag == 2)
    {
...
void si5351aSetFreq(int synth, unsigned long  freq)
{
  ...
  a = ((XtalFreq * 36) /4) / freq; // 36 is derived from 900/25 MHz
